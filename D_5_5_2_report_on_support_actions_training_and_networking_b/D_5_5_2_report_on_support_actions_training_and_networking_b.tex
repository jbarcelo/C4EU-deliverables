...
At the time of this writing, the fellows recruited for the second round of bottom-up broadband pilots are already working.
...
\begin{IEEEkeywords}
 Bottom-up-Broadband (BuB), training, networking
...
After this introduction, Section \ref{sec:about} explains that this is a collaborative document open for anyone to contribute.
Section \ref{sec:fellows} introduces the fellow program that we have prepared to back the execution of the selected pilots.
Section \ref{sec:mentor} describes the roles of mentor and academic advisor that will help the fellows participating in the pilots.
...
FFTx & Jorge Beltran & Roger Baig & Albert Domingo\\
Mobile Node & Fernando Gros & Efrain Foglia & Jaume Barcelo\\
Sensor Testbed & Sergio Almendros & TBD & Jaume Barcelo\\
Visual Interface& Ferran Selva & J. M. Velilla & Jaume Barcelo\\
Forest Data Collection & Ryan Chetcuti & Dr. R. Clement & Dr. M. Marina\\
Android Mesh Networks& Aleix Sala & Daniel Camps & Josep Paradells\\
BuB Operator Business Model & Ivan Fernandez & Albert Domingo& Miquel Oliver\\
WMN fibre interconnection & Pedro Vilchez & Roger Baig and Pedro Lorente& Jaume Barcelo\\
\hline
\end{tabular}
\end{table}
...
The mentors that volunteered to participate in the program follow:

\subsection{Mentors for the OSN pilot}

The leads of the Smart Citizen Kit initiative provide help and supervision to this pilot.
...
Nacho Justel will be guided by Giovanni Calcerano from Provicia WiFi.
Giovanni is graduated in Mathematics, and developed his carrer mostly as consultant in the field of high-level technical computing / scientific / statistical experience with over ten-year experience in the business sector. He is currently working at Provincia di Roma in European projects such as OpenData.
...
\par 
He graduated in Design of Graphic Communication in UAM (Mexico) and he holds a Ph.D. from  Universitat de Barcelona (UB) about \textit{Art in MediaCity}.    

\subsection{Mentors for Remote Sensor Data Collection}

Dr. Mahesh Marina is a lecturer at the Institute for Computing Systems Architecture (ICSA) at the University of Edinburgh. He is involved in the bottom-up broadband rural Network Tegola.

Dr. Robert J. Clement is a Research Associate at the School of GeoSciences at University of Edinburgh. 
He is participating in the monitoring of the Griffin Scottish forest.

\subsection{Mentor for Android Mesh Networks}

Daniel Camps is a researcher in the field of wireless communication. His interests include wireless networks, QoS and energy efficiency. 

\subsection{Mentor for the BuB business model}

Albert Domingo is a Ph.D. student interested in Regulation, Next Generation Access Networks and Open Data.

\subsection{Mentors for the WMN fiber interconnection}

Pedro Lorente is co-founder and research engineer at IGLOR. 
He also worked for several years at i2cat, an innovation center for future Internet.

Roger Baig works for the Guifi Foundation and has been involved in the guifi.net community network from its early beginnings.
...
In the workshop the fellows present the advancements in the last two weeks, and the plans for the next two weeks.
It is also a good place to discuss possible obstacles, opportunities, re-planning and, in general, to share experiences related to the pilots.
The workshop helps the fellows to keep track of all the pilots and identify possibilities of collaboration.
...
The mailing list, which is provided by guifi.net,  runs on free software.
It is an open mailing list and anyone can subscribe or check the archived mail ``https://llistes.guifi.net/sympa/arc/bub''.
...
The mailing list is a convenient tool for the daily work and to keep track of progress between meetings and workshops.
...
The number of members has doubled in the last year.
...
The International Summit of Wireless Community Networks was performed in Barcelona between 4 and 7 of October 2012. The summit was a venue where the participants could share their diverse knowledge and strategies about new technology infrastructure needs.
Another topic of interest was the formulation of policy reforms to empower citizens by means of bottom-up broadband initiatives.
Three partners of our consortium participated in the event.


Ramon Roca spoke in the opening event, and also participated during all the summit.
In the opening he informed the participants about the advantages of the BuB sustainability model compared to more traditional models.
Sharing infrastructure as commons \cite{oliver2010wca} can be much more efficient.
As an example, Ramon also explained the successful completion of the second phase of the BuB fiber deployment in Gurb.

Miquel Oliver talked about the C4EU project, and especially about the BuB branch of the project. 
And Federico Capoano, from Caspur, presented the need of creating accessible documentation for non-geeks.

\subsection{5th International Workshop on Multiple Access Communications}

This workshop took place in Maynooth (Ireland) on the 19th and 20th of November of 2012.
The technical program comprised talks and demonstrations of the latest advancements in the field by academy and industry leading institutions.
...
\subsection{Pirinelab'13}
This is a retreat in the Pirenees Mountains that gathers hackers and enterpreneurs to explore the latest bottom-up technologies and their application to rural and mountain areas.
One of the fellows attended Pirinelab in representation of Bottom-up Broadband and established contacts and gathered information useful for all the pilots.
...
As we are interested in bottom up initiatives, it is necessary to build a community with people and links that span beyond the consortium.
...
As a novelty for this year, we are preparing an online course to train the citizens in bottom-up technologies.
...
\bibliography{IEEEabrv,my_bib,course}
%
